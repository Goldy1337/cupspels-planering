...
export default function LoginHeader(props) {
  ...
  const createMemberAccount = async (e) => {
    ...
    if (newMember.js.error) {
      ...
      if (!props.isTeamMember) closeAccountCreationModal();
    }
  };
      ...
      {props.isTeamMember ? (
        ...
        <div>
          <Navbar className="loginHeader" color={colorTheme} dark>
            <NavbarBrand href="/" className="loginHeaderText">
              Cupplanner
            </NavbarBrand>
            <Nav navbar>
              {loginStatus.user ? (
                <Button className="loginHeaderButton" color={colorTheme}>
                  My Account
                </Button>
              ) : (
                <Button
              ...
              <Modal
                isOpen={modalCreateAccount}
                toggle={modalCreateAccount}
                className={className}
                color={colorTheme}
              >
                <ModalHeader
              ...
              <Modal
                ...
                className={className}
              >
                <ModalHeader toggleLogin={toggleLogin} close={closeBtnLogin}>
                  Login
                </ModalHeader>
                <ModalBody>
                  <Form>
                  ...
                  <p>{errorMessage}</p>
                  <p>
                    Superadmin: god@gmail.com, 666 Testadmin: admin@gmail.com,
                    100 Testref: ref@gmail.com, 200
                  </p>
                </ModalBody>
                <ModalFooter>
          ...
          <Button onClick={deleteUsers} color={colorTheme}>
            Delete Users
          </Button>
          <br></br>
          <Button onClick={getUserData} color={colorTheme}>
            User Data
          </Button>
          <br></br>
          <Button onClick={toggleColorMode} color={colorTheme}>
            Change Colormode
          </Button>
        </div>
      )}
